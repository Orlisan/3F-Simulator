    ...
    static void configuraTasti() {
    	...
    	mappaClasse.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                switch(e.getKeyCode()) {
                    case KeyEvent.VK_UP: if(nonToccaSu) { muoviPersonaggio(0, -1); facciata = Direzione.SU;  break; }
                    case KeyEvent.VK_DOWN: if(nonToccaGiù) {muoviPersonaggio(0, 1); facciata = Direzione.GIU; break;}
                    case KeyEvent.VK_LEFT: if(nonToccaASinistra) muoviPersonaggio(-1, 0); facciata = Direzione.SINISTRA; break;
                    case KeyEvent.VK_RIGHT: if(nonToccaADestra) { muoviPersonaggio(1, 0); facciata = Direzione.DESTRA; break;}
